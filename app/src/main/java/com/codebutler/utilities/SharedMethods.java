package com.codebutler.utilities;
...
import com.codebutler.NewKeywordEntryActivity;
...
public class SharedMethods {
    ...
    public static List<String[]> readCSVFile(String filename, Context context, String separator) {
